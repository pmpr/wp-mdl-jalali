...
"use strict";
/*!******************************************!*\
  !*** ./asset/js/virastar.js + 1 modules ***!
  \******************************************/

;// CONCATENATED MODULE: external "jQuery"
const external_jQuery_namespaceObject = jQuery;
var external_jQuery_default = /*#__PURE__*/__webpack_require__.n(external_jQuery_namespaceObject);
// EXTERNAL MODULE: ./node_modules/virastar/lib/virastar.js
var lib_virastar = __webpack_require__(686);
var virastar_default = /*#__PURE__*/__webpack_require__.n(lib_virastar);
;// CONCATENATED MODULE: ./asset/js/virastar.js




external_jQuery_default()(document).ready(function () {
    external_jQuery_default()('#virastar').on('click', function () {

        editEditorContent();
    });

    function editEditorContent() {
        if (typeof tinymce !== "undefined") {

            let virastar = new (virastar_default())();
            tinymce.activeEditor.setContent(virastar.cleanup(tinymce.activeEditor.getContent()))
        }
    }
});
})();
